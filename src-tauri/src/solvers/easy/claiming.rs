...
mod claiming_test {
    ...
    use super::*;
    #[test]
    fn test_claiming_found(){
        let raws = [20,32,2,20,64,1,128,256,8,256,65,129,2,140,140,68,16,32,84,8,144,436,404,180,70,71,69,80,67,49,149,157,140,62,38,256,8,4,256,80,32,2,1,128,80,128,67,49,341,285,76,126,38,84,2,256,64,37,21,52,52,8,128,1,16,8,228,132,256,100,100,2,32,128,4,8,2,80,256,65,17];
        let game_board = GameBoard::from_array(raws);
        let solver = Claiming;
        let Solution{actions,house_clues,candidate_clues} = solver.solve(&game_board).unwrap();
    ...
    fn test_claiming_not_found(){
        let raws = [20,32,2,20,64,1,128,256,8,256,65,129,2,140,140,68,16,32,84,8,144,436,404,180,70,71,69,80,67,49,149,157,140,62,38,256,8,4,256,80,32,2,1,128,80,128,3,49,341,285,76,126,38,84,2,256,64,37,21,52,52,8,128,1,16,8,228,132,256,100,100,2,32,128,4,8,2,80,256,65,17];
        let game_board = GameBoard::from_array(raws);
        let solver = Claiming;
