...
mod sue_de_coq_test {
    ...
    fn sue_de_coq_test_3() {
        test_function_e(
            ...
            vec![(3, 7), (3, 8), (5, 6), (5, 8), (4, 1)], //exp_actions
            vec![64, 256, 256, 256, 128],                 //exp_action_targets
            vec![Box(5), Row(4)],                         //house_clues
            vec![
                (3, 6),
                (0, 0),
                (4, 6),
            ...
            vec![
                320, 65535, 320, 64, 256, 65535, 129, 65535, 1, 128, 128, 65535, 8, 8,
    ...
    fn sue_de_coq_test_4() {
        test_function_e(
            ...
            vec![272, 16, 16, 10],                //exp_action_targets
